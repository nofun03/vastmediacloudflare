...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'contentmain@bntechauto.info',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: '/icons/vastmedia.png',

  // The name of your website. Present alongside your icon.
  title: "VAST MEDIA BANGLADESH",

  // The folder that you are to share publicly with onedrive-cf-index-ng. Use '/' if you want to share your root folder.
  baseDirectory: process.env.BASE_DIRECTORY || '/vastmedia',
  ...
  footer:
    'Made with 💙 VAST MEDIA BANGLADESH',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/vastmedia',],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'contentmain@bntechauto.info',
